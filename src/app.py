...
activities = {
    ...
    "Soccer Team": {
        "description": "Team-based soccer practice and league play",
        "schedule": "Mondays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["alex@mergington.edu", "nina@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Swimming drills, fitness, and competitions",
    ...
    "Math Olympiad": {
        "description": "Prepare for challenging math competitions and problem solving",
        "schedule": "Mondays and Wednesdays, 4:00 PM - 5:00 PM",
        "max_participants": 16,
        "participants": ["bella@mergington.edu", "owen@mergington.edu"]
    },
    "Debate Team": {
        "description": "Practice persuasive speaking and competitive debate formats",
        "schedule": "Thursdays and Saturdays, 4:30 PM - 6:00 PM",
        "max_participants": 14,
